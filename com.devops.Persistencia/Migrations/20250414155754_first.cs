        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    id_pais = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    FechaCreacion = table.Column<DateTime>(type: "datetime2", nullable: false),
                    paisId_pais = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Region", x => x.Id_region);
                    table.ForeignKey(
                        name: "FK_Region_Pais_paisId_pais",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id_comuna = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Nombre = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Id_region = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    FechaCreacion = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DBComuna", x => x.Id_comuna);
                    table.ForeignKey(
                        name: "FK_DBComuna_Region_Id_region",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DBComuna_Id_region",
                table: "DBComuna",
                column: "Id_region");

            migrationBuilder.CreateIndex(
                name: "IX_Region_paisId_pais",
                table: "Region",
                column: "paisId_pais");
        }
